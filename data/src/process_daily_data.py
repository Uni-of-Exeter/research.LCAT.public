...
class ClimateDataProcessor:
    ...
    def _create_http_session(self: "ClimateDataProcessor", pool_connections: int = 20, pool_maxsize: int = 20) -> requests.Session:
    ...
    def get_file_links(self: "ClimateDataProcessor") -> None:
        ...
        base_url = (
            f"https://dap.ceda.ac.uk/badc/deposited2021/chess-scape/data/rcp{self.rcp}{bias_corrected_suffix}/{ensemble_str}/daily/{self.variable}/"
        )
        ...
        try:
            ...
            raise RuntimeError(f"Failed to fetch NetCDF listing from {base_url}: {exc}") from exc
