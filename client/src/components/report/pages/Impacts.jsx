...
const getCommunityImpactIcon = (impactName) => {
    const iconMap = {
        ...
        "Adaptation and/or mutation of microorganisms to antibiotics, chemicals and environmental stressors":
            AdaptationMicroorganismsIcon,
    };
    ...
    return (
        <View style={styles.section}>
            ...
            <Text style={styles.bodyText}>
                ...
                <Text style={[styles.bodyText, { fontWeight: "bold" }]}>{selectedImpactHazard}</Text>. These impacts
                will vary by local area.
            </Text>
            ...
            {includeHealthImpacts && (
                <>
                    ...
                    <Text style={styles.bodyText}>
                        ...
                        <Text style={[styles.bodyText, { fontWeight: "bold" }]}>negative impact</Text> on health,
                        including{" "}
            ...
            {includeCommunityImpacts && (
                <>
                    ...
                    <Text style={styles.bodyText}>
                        ...
                        <Text style={[styles.bodyText, { fontWeight: "bold" }]}>negative impact</Text> on essential
