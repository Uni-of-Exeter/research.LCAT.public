...
const PdfDownloader = ({ pdfDocument, fileName, onDone }) => {
    ...
    if (instance.url)
        return (
            <a href={instance.url} download={fileName} onClick={handleClick}>
                ...
                {hasSelectedRegions ? (
                    <>
                        <div className="pdf-button-container">
                            <button onClick={handleReportClick} className="generate-report-button">
                    ...
                    <div className="select-region-prompt">Select a region to generate report</div>
                )}
            </div>
